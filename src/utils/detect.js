...
const preprocess = (source, modelWidth, modelHeight) => {
  ...
  const input = tf.tidy(() => {
    ...
    // const h = Math.ceil(img.shape.slice(0));
    // const w = Math.ceil(img.shape.slice(2));
    ...
    // const resizedFloatImage = tf.image.resizeBilinear(imgPadded, [modelWidth, modelHeight]).div(255.0).expandDims(0);
    // const resizedIntImage = resizedFloatImage.cast('int32');
    // console.log(resizedFloatImage)
    // console.log(resizedIntImage)
    
    // return resizedIntImage
